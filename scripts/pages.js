...
<section>
  <div class="wrap">
    <div id="formWrapper" class="form-container" style="max-width: 100%;">
      <iframe id="googleForm" src="https://docs.google.com/forms/d/e/1FAIpQLSc40eS3C9MPcJUMwW202LO6xjYr3_CGse_ySfCDqBtAnTOskQ/viewform?embedded=true" width="100%" height="1200" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
    </div>

    <script>
      // Detect form submission and redirect home
      const iframe = document.getElementById('googleForm');
      let lastHeight = iframe.offsetHeight;

      // Monitor iframe for size changes that indicate form submission
      setInterval(() => {
        try {
          const currentHeight = iframe.offsetHeight;
          // If height changes significantly, form was likely submitted
          if (Math.abs(currentHeight - lastHeight) > 100) {
            // Show a message and redirect after 1 second
            const wrapper = document.getElementById('formWrapper');
            wrapper.innerHTML = '<div style="padding: 3rem; text-align: center;"><h2 style="color: var(--signal); margin-bottom: 1rem;">✓ Thank you!</h2><p style="color: var(--slate); font-size: 1.1rem;">Your resume has been submitted successfully. Redirecting to home...</p></div>';
            setTimeout(() => {
